...
<template>
    <Head title="Tambah Mobil - Rizkya Admin" />

    <AdminLayout activeTab="kelola_mobil" title="Tambah Mobil Baru">
                    ...
                    <form @submit.prevent="submitCarForm" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 font-normal">
                            ...
                            <div class="flex flex-col font-normal">
                                ...
                                <input v-model="carForm.model" type="text" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: Fortuner" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 font-normal">
                            <div class="flex flex-col font-normal">
                                ...
                                <input v-model="carForm.year" type="number" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: 2022" />
                            </div>
                            <div class="flex flex-col font-normal">
                                <label class="text-[15px] font-normal text-slate-500 mb-2">Harga (Rp)</label>
                                <input v-model="carForm.price" type="number" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: 400000000" />
                            </div>
                            <div class="flex flex-col font-normal">
                                <label class="text-[15px] font-normal text-slate-500 mb-2">Kilometer</label>
                                <input v-model="carForm.mileage" type="number" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: 15000" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 font-normal">
                            <div class="flex flex-col font-normal">
                                ...
                                <input v-model="carForm.engine" type="text" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: 2400cc" />
                            </div>
                            <div class="flex flex-col font-normal">
                                <label class="text-[15px] font-normal text-slate-500 mb-2">Warna Bodi</label>
                                <input v-model="carForm.color" type="text" required class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal" placeholder="Contoh: Hitam" />
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col font-normal">
                            ...
                            <textarea v-model="carForm.description" rows="5" class="bg-slate-50 border border-slate-200 rounded-md px-3 py-2 text-[15px] text-slate-800 focus:outline-none focus:border-slate-500 focus:ring-1 font-normal resize-none" placeholder="Tuliskan deskripsi lengkap mobil di sini..."></textarea>
                        </div>

                        <!-- Images -->
                        <div class="flex flex-col font-normal">
                            <label class="text-[15px] font-normal text-slate-500 mb-2">Unggah Gambar (Minimal 4 gambar)</label>
                            <input @input="carForm.images = $event.target.files" type="file" required multiple accept="image/*" class="text-[14px] text-slate-600 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-[14px] file:font-medium file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200" />
                        </div>
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-slate-100 font-normal">
                            ...
                            <button type="submit" :disabled="carForm.processing" class="bg-blue-600 text-white hover:bg-blue-700 px-5 py-2 rounded-md font-medium text-[14px] transition shadow-sm disabled:opacity-50">
                                {{ carForm.processing ? 'Menyimpan...' : 'Tambah Mobil' }}
                            </button>
                        </div>
                    </form>
                </div>
